...
//             {[...Array(5)].map((_, i) => (
//                 <Star key={i} className={`w-3.5 h-3.5 ${isDark ? 'text-neon fill-neon' : 'text-emerald-500 fill-emerald-500'
//                     }`} />
//             ))}
//         </div>
//     );
...
//             className={`rounded-2xl p-8 flex flex-col ${isDark
//                     ? 'glass-card'
//                     : 'bg-white border border-gray-200 shadow-sm hover:shadow-lg hover:border-emerald-200'
//                 }`}
//         >
//             {/* Quote Icon */}
//             <Quote className={`w-10 h-10 mb-4 -scale-x-100 ${isDark ? 'text-neon/30' : 'text-emerald-200'
//                 }`} />
...
//             {/* Review Text */}
//             <p className={`text-sm leading-relaxed italic flex-1 mb-8 ${isDark ? 'text-white/60' : 'text-gray-500'
//                 }`}>
...
//                 {/* Avatar */}
//                 <div className={`w-10 h-10 rounded-full flex items-center justify-center shrink-0 ${isDark ? 'bg-neon/20' : 'bg-emerald-50'
//                     }`}>
//                     <span className={`text-sm font-semibold ${isDark ? 'text-neon' : 'text-emerald-600'
//                         }`}>
...
//                 {/* Name & Company */}
//                 <div>
//                     <p className={`font-medium text-sm ${isDark ? 'text-white' : 'text-[#1e1b4b]'
//                         }`}>{testimonial.name}</p>
...
//     return (
//         <section className={`relative py-16 md:py-20 overflow-hidden ${isDark ? 'bg-dark-900' : 'bg-[#f5f5f7]'
//             }`}>
...
//                     className={`text-xs tracking-[0.3em] text-center mb-4 font-semibold ${isDark ? 'text-neon' : 'text-emerald-600'
//                         }`}
//                 >
//                     EARLY FEEDBACK
//                 </motion.p>
